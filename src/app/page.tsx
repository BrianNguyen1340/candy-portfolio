    ...
    <section id='home' className='relative h-fit w-full'>
      <div className='relative mx-auto flex h-full w-fit flex-col items-start justify-between gap-8 xxs:w-[300px] xs:w-[450px] sm:w-[600px] md:w-[750px] md:flex-row md:gap-4 md:pt-10 lg:w-[950px] xl:w-[1200px]'>
        <div className='flex flex-1 flex-col'>
          ...
          <div className='relative left-0 mb-4 pl-0 text-base font-semibold uppercase tracking-widest before:absolute before:left-0 before:top-3 before:h-[2px] before:w-0 before:bg-gray-500 dark:text-white xs:mb-8 md:pl-20 md:text-lg md:before:top-6 md:before:w-16 lg:text-xl xl:text-2xl'>
            <TypeAnimation
              sequence={[
                `i am ux/ui designer`,
                2000,
